...
try {
    ...
    DB::commit();
    echo "\n====== IMPORT SELESAI ======\n";
    echo "Berhasil memasukkan/memperbarui {$insertedCount} data keanggotaan baru.\n";
    echo "Password default untuk semua akun baru: 'poljar123'\n";
} catch (\Exception $e) {
    DB::rollBack();
